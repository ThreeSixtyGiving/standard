...
Below there is specific step-by-step guidance for community foundations using the D2 tool, and links to other relevant guidance found on this site. You can also [download this guidance](../../assets/Data_preparation_guide_for_community_foundations-PDF_version.pdf) [PDF 384kb].
