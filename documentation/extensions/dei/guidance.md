...
As part of 360Giving’s support for the DEI Data Standard, we hold a regular free workshop, [**Introduction to the DEI Data Standard**](https://360giving.org/support/training-and-workshops/workshops/#free-publishing-workshops), which explains the key concepts and decisions for funders who want to start collecting DEI data.
