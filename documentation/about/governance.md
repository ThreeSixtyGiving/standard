...
The strategy for the Standard is a core part of the 360Giving strategy. The 2022-25 strategy – [Unleashing the Impact of Grants Data](https://360giving.org/about/unleashing/) – aims to shift the norm from funders sharing data to using it, and create a permanent transformation in data culture and practice.
...
For further details see the [current membership of the Stewardship Committee](https://360giving.org/support/standard/) and the [Terms of Reference](../../about/sc-tor). To contact the Stewardship Committee please email <standard@threesixtygiving.org>.
...
The issues and proposals raised through all channels will be prioritised by considering user needs and demand, and will be guided by [360Giving strategy](https://360giving.org/about/unleashing/) and [values](https://360giving.org/about/our-values/).
